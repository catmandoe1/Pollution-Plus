...
public class TileVoidPoweredFilter extends TileEntity implements ITickable {
	private final int maxCapacity = PollutionPlusConfig.PoweredFilters.vvoid.filterMaxCapacity;
	...
	public boolean canRun() {
		return getEnergyStored() >= PollutionPlusConfig.PoweredFilters.vvoid.filterPowerUse;
	}
	...
	public void useTickPower() {
		addOrRemoveEnergy(PollutionPlusConfig.PoweredFilters.vvoid.filterPowerUse * -1);
	}
	...
	private void updateState(boolean isPowered) {
		if (world.getBlockState(pos) != null) {
			world.setBlockState(pos, world.getBlockState(pos).withProperty(BlockVoidPoweredFilter.ACTIVE, isPowered));
		}
	}
