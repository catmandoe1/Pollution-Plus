...
public class HydraulicPressRecipeCatergory implements IRecipeCategory<HydraulicPressRecipeWrapper> {
	public static final String UID = Reference.MODID + ".hydraulic_press";
	...
	public HydraulicPressRecipeCatergory(IGuiHelper guiHelper) {
		ResourceLocation location = new ResourceLocation(Reference.MODID + ":textures/jei/gui/hydraulic_press.png");
		background = guiHelper.createDrawable(location, 0, 0, 86, 30);
		localizedName = I18n.format("pollutionplus.jei.hydraulic_press");
		icon = guiHelper.createDrawableIngredient(new ItemStack(BlockInit.TILE_HYDRAULIC_PRESS));
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, HydraulicPressRecipeWrapper recipeWrapper, IIngredients ingredients) {
