...
public class ContainerDischarger extends Container {

	private final TileDischarger tileentity;
	private int progress, maxProgress, energy, maxEnergy;
	
	public ContainerDischarger(InventoryPlayer player, TileDischarger tileEntity) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 1) {
                ...
                if (!DischargerRecipes.getInstance().getRecipeResult(itemstack1).isEmpty()) {
