...
public class ContainerHydraulicPress extends Container {
	...
	public ContainerHydraulicPress(InventoryPlayer player, TileHydraulicPress tileentity) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 1) {
                ...
                if (!HydraulicPressRecipes.getInstance().getRecipeResult(itemstack1).isEmpty()) {
